...
class ForegroundExtraction:
    """Background subtraction helper used by the material detector tests."""
    def __init__(self,
...
class ContourProcessor:
    """Contour processor used to measure material coverage in binary masks."""
    def __init__(self,
                 min_contour_area=100,
                 use_convex_hull=True,
                 merge_overlapping=False,
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Material detector with background subtraction and contour processing')
    ...
    parser.add_argument('--save-video', type=Path,
                        help='Save output video (optional)')
    parser.add_argument('--max-frames', type=int,
                        help='Limit the number of processed frames (optional)')
...
def filter_coverage(raw_cov: float) -> tuple[float, bool]:
    """Smooth coverage readings with median, moving-average, and spike gates."""
    global prev_cov
